...
vim.api.nvim_create_autocmd("BufEnter", {
	...
	callback = function()
		...
		vim.opt_local.formatprg = "par -w70"
	end,
})

-- Markdown pandoc helpers
...
-- RenameWithQflist for Python and Lua
vim.api.nvim_create_autocmd("BufEnter", {
	pattern = { "*.py", "*.lua" },
	callback = function()
		vim.keymap.set("n", "<leader>lr", lsp_handlers.rename_with_qflist, { buffer = true, desc = "Rename with quickfix list" })
	end,
})
