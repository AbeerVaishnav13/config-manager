...
# /opt/homebrew/bin/brew install rust rust-analyzer helix marp-cli alacritty

####### Install casks #######
# /opt/homebrew/bin/brew --cask install wezterm basictex klayout paraview zoom discord anaconda brave-browser xquartz slack amethyst keka elmedia-player git-delta
